...
namespace MirraGames.SDK.GameDistribution
{
    ...
    public class GameDistributionAds : CommonAds
    {
        ...
        public GameDistributionAds(IEventAggregator eventAggregator) : base(eventAggregator)
        {
            SetInitialized();
        }
        ...
        protected override void InvokeInterstitialImpl(InterstitialParameters parameters, Action onOpen, Action<bool> onClose)
        {
            ...
            {
                Logger.CreateWarning(this, "GD ShowAd failed. Make sure you are running a WebGL build in a browser", e.Message);
            }
        }
        ...
        internal void PreloadRewardedAd()
        {
            ...
            {
                Logger.CreateWarning(this, "GD Preload failed. Make sure you are running a WebGL build in a browser", e.Message);
            }
        }
